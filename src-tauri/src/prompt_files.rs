...
pub fn prompt_file_path(app: &AppType) -> Result<PathBuf, AppError> {
    ...
    let base_dir: PathBuf = match app {
        AppType::Claude | AppType::Trae | AppType::CodeBuddy => get_base_dir_with_fallback(get_claude_settings_path(), ".claude")?,
    ...
    let filename = match app {
        AppType::Claude | AppType::Trae | AppType::CodeBuddy => "CLAUDE.md",
